...
def sf_art_update_raw_data(conn_sf, conn):
	project_list = {
		...
		"optimism":{
			"sf_tables":{
				"EZ_METRICS":["DATE", "AVG_TXN_FEE", "DAU", "DAU_OVER_100", "DEX_VOLUMES", "FDMC", "FEES", "FEES_NATIVE", "HIGH_SLEEP_USERS", "LOW_SLEEP_USERS", "L1_DATA_COST", "L1_DATA_COST_NATIVE", "MARKET_CAP", "MAU", "NEW_USERS", "NFT_TRADING_VOLUME", "NON_P2P_STABLECOIN_TRANSFER_VOLUME", "NON_SYBIL_USERS", "P2P_NATIVE_TRANSFER_VOLUME", "P2P_STABLECOIN_TRANSFER_VOLUME", "P2P_TOKEN_TRANSFER_VOLUME", "P2P_TRANSFER_VOLUME", "PRICE", "RETURNING_USERS", "REVENUE", "REVENUE_NATIVE", "SETTLEMENT_VOLUME", "STABLECOIN_DAU", "STABLECOIN_TOTAL_SUPPLY", "STABLECOIN_TRANSFER_VOLUME", "STABLECOIN_TXNS", "SYBIL_USERS", "TVL", "TXNS", "WEEKLY_COMMITS_CORE_ECOSYSTEM", "WEEKLY_COMMITS_SUB_ECOSYSTEM", "WEEKLY_CONTRACTS_DEPLOYED", "WEEKLY_CONTRACT_DEPLOYERS", "WEEKLY_DEVELOPERS_CORE_ECOSYSTEM", "WEEKLY_DEVELOPERS_SUB_ECOSYSTEM"]
			},
			"local_cols":["project_name", "datestamp", "avg_txn_fee", "dau", "dau_over_100", "dex_volumes", "fdmc", "fees", "fees_native", "high_sleep_users", "low_sleep_users", "l1_data_cost", "l1_data_cost_native", "market_cap", "mau", "new_users", "nft_trading_volume", "non_p2p_stablecoin_transfer_volume", "non_sybil_users", "p2p_native_transfer_volume", "p2p_stablecoin_transfer_volume", "p2p_token_transfer_volume", "p2p_transfer_volume", "price", "returning_users", "revenue", "revenue_native", "settlement_volume", "stablecoin_dau", "stablecoin_total_supply", "stablecoin_transfer_volume", "stablecoin_txns", "sybil_users", "tvl", "txns", "weekly_commits_core_ecosystem", "weekly_commits_sub_ecosystem", "weekly_contracts_deployed", "weekly_contract_deployers", "weekly_developers_core_ecosystem", "weekly_developers_sub_ecosystem"]
		},
		"polkadot":{
			"sf_tables":{
